...
@NgModule({
  declarations: [WarehouseComponent, CarComponent, PpeComponent, MaterialComponent, ProjectComponent, AddCarInfoComponent,
    ...
    CarReportComponent, MaterialAddComponent, MaterialListComponent, MaterialArchiveComponent,
    MaterialReportComponent, PpeAddComponent, PpeArchiveComponent, PpeListComponent, PpeReportComponent, CompanyComponent, ProjectListComponent, ProjectArchiveComponent, ProjectAddComponent, CompanyAddComponent, CompanyListComponent, CompanyArchiveComponent, CompanyPopupComponent, PpePopupComponent, CarPopupComponent, MaterialPopupComponent, ProjectPopupComponent],
  imports: [
    CommonModule,
